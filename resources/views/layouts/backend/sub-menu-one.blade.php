                    ...
                    <div class="modal-content">
                        <div class="modal-header no-padding">
                            <div class="table-header">
                                ...
                                <span><i class="ace-icon fa fa-pencil" style="font-size:17px;color:#ffffff !important"></i></span>&nbsp;&nbsp; Sub Menu Lebel One Entry Form
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header no-padding">
                            <div class="table-header">
                                ...
                                <span><i class="ace-icon fa fa-pencil" style="font-size:17px;color:#ffffff !important"></i></span>&nbsp;&nbsp; Sub Menu Lebel One Update Form
                            </div>
                        </div>
                        <div class="modal-body no-padding"></div>
                        <div class="row">
