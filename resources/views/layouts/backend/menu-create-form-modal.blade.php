<form action="#" method="post" id="mainMenuInfo" enctype="multipart/form-data">
    @csrf
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="name">English Name<span class="frequired">*</span></label>
            <input type="text" class="form-control form-control-sm required" id="name" name="name" autocomplete="off">
            @if($errors->has('name'))
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control form-control-sm required" id="name" name="name_bn" autocomplete="off">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <select name="menu_id" class="form-control form-control-sm required" id="menu_id">
