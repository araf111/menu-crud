        ...
        <div class="col-md-12">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <span class="block input-icon input-icon-right">
                        <input type="title" class="form-control form-control-sm required" id="title" name="title" autocomplete="off" placeholder="title">
                ...
                <div class="form-group col-md-6">
                    ...
                    <span class="block input-icon input-icon-right">
                        <input type="subtitle" class="form-control form-control-sm required" id="subtitle" name="subtitle" autocomplete="off" placeholder="subtitle">
                        <i class="ace-icon fa fa-edit fci"></i>
                    </span>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 inner_wrap_two">
                    ...
                    <select name="sub_menu_two_id" class="form-control form-control-sm" id="sub_menu_two_id">
                        ...
                        <option value="{{$submenutwo->id}}">{{$submenutwo->name}}</option>
                        @endforeach
                    </select>
                    @if($errors->has('menu_id'))
                        <span class="danger">{{ $errors->first('status') }}</span>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="file" class="form-control form-control-sm" id="image_one" name="image_one">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="file" class="form-control form-control-sm" id="image_two" name="image_two">
