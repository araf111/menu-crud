                    ...
                    <div class="modal-content">
                        <div class="modal-header no-padding">
                            <div class="table-header">
                                ...
                                <span><i class="ace-icon fa fa-pencil" style="font-size:17px;color:#ffffff !important"></i></span>&nbsp;&nbsp; Sub Menu Lebel Two Entry Form
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header no-padding">
                            <div class="table-header">
                                ...
                                <span><i class="ace-icon fa fa-pencil" style="font-size:17px;color:#ffffff !important"></i></span>&nbsp;&nbsp; Sub Menu Lebel Two Update Form
                            </div>
                        </div>
