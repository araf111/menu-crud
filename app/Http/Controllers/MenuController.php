...
class MenuController extends Controller
{
    ...
    public function index(){
        $menus = Menu::all();
        return view('layouts.backend.main-menu',compact('menus'));
    }
                ...
                $actionBtn =
                    '<td class="text-center">
                        <div class="hidden-sm hidden-xs action-buttons">
                            ...
                            <a href="#" class="red destroy" data-route="' . route('menu.delete', $list->id) . '">
    ...
    public function store(Request $request){
        ...
        $arr = [
            'organization_id' => Auth::user()->organize_id,
            'name' => $request->name,
    ...
    public function edit(Request $request){
        ...
        $returnHTML = view(
            'layouts.backend.menu-update-form',
            [
                'menu' => $menu
            ]
        )->render();
    ...
    public function update(Request $request){
        ...
        $mObj = Menu::where('id', $request->id)->update($arr);
